...
class WeightPageGairl extends StatelessWidget {
  const WeightPageGairl({super.key});
              ...
              child: SleekCircularSlider(
                ...
                appearance: CircularSliderAppearance(
                  customColors: CustomSliderColors(
                    progressBarColor: const Color(0xffFDB5FF),
                  ...
                  infoProperties: InfoProperties(
                    mainLabelStyle: const TextStyle(fontSize: 70, color: Color(0xffFDB5FF)),
